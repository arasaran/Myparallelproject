...
{ 
	...
	public void addFilm(Map<Integer, Object> filmSet) throws EmptyFieldException, RecordNotFoundException, NegativeIdException
	...
	public void modifyFilm(Map<String, Object> filmDetails) throws RecordNotFoundException, EmptyFieldException, NegativeIdException
	{
	...
	public boolean removeFilm(int filmId) throws NegativeIdException, EmptyFieldException, RecordNotFoundException
	{
		if(filmId<0)
	...
	public Film searchFilm(int filmId) throws NegativeIdException, EmptyFieldException, RecordNotFoundException
	{
		if(filmId<0)
			throw new NegativeIdException();
		else if(filmId==0)
